    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          Découvrez l'histoire de Jenny Shop, votre destination shopping préférée
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Notre histoire</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Fondée en 2024, Jenny Shop est née d'une passion commune pour le shopping en ligne et le désir de rendre les achats plus accessibles à tous.
          </p>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
        ...
        <div className="bg-primary-100 dark:bg-primary-900/20 p-8 rounded-lg">
          <img 
      ...
      {/* Valeurs */}
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-white mb-12">Nos valeurs</h2>
