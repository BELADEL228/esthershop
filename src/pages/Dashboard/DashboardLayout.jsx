...
import {
  ...
  ChartBarIcon,
  EnvelopeIcon,
  ChatBubbleLeftRightIcon  // ← AJOUTÉ pour les messages
...
const navigation = [
  ...
  { name: 'Messages', to: '/dashboard/messages', icon: ChatBubbleLeftRightIcon }, // ← AJOUTÉ
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="ml-64 p-8">
        ...
        {showNewsletter && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8 border border-gray-200 dark:border-gray-700 animate-fadeIn">
